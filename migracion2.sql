...
BEGIN
    ...
    INSERT BASADOS.material(mat_nombre, mat_descripcion, mat_precio, mat_tipo)
        ...
        FROM gd_esquema.Maestra WHERE Material_Nombre is not NULL
    ...
    INSERT BASADOS.tela(tela_material, tela_color, tela_textura)
        SELECT DISTINCT 
            ...
            Tela_Color,
            Tela_Textura
        FROM gd_esquema.Maestra where Material_Tipo = 'Tela'
    ...
    SELECT DISTINCT
        ...
        Relleno_Densidad
    FROM gd_esquema.Maestra WHERE Material_Tipo = 'Relleno'
    ...
    INSERT BASADOS.cancelacion(canc_pedido, canc_fecha, canc_motivo)
    SELECT DISTINCT Pedido_Numero, Pedido_Cancelacion_Fecha, Pedido_Cancelacion_Motivo 
    FROM gd_esquema.Maestra WHERE Pedido_Estado = 'Cancelado' AND Pedido_Cancelacion_Fecha IS NOT NULL AND Pedido_Cancelacion_Motivo IS NOT NULL
    ...
    INSERT BASADOS.material_por_sillon(mat_sillon, mat_material)
